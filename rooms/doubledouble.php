  ...
  <table class="table">
    ...
    <tr>
      <td>
        ...
        <img src="../main/5.jpg">
        <br><br>
        <h3>A double double type is a room with two beds. It may be occupied by one to two person. It has a 
table and a TV.</h3>
      </div>
      </td>
      <td colspan="2">
      <form action="create_reservation.php" method = "POST" enctype="multipart/form-data" >
        <div class="txtb">
            ...
            <input type="text" style="color:#1EA1A1" id="room" name="room" value="Double Double Type Room"> <br>
          </div>
          <div class="txtb">
            <label><b>Price :</b></label>
            <input type="text" style="color:#1EA1A1" id="price" name="price" value="2000.00"> <br>
        </div>
          <div class="txtb">
