    ...
    <tr>
      ...
      <form action="payment.php" enctype="multipart/form-data" >
        <div class="txtb">
            ...
            <input type="text" style="color:#1EA1A1" id="room" name="room" value="Studio Type Room"> <br>
          </div>
          <div class="txtb">
            <label><b>Price :</b></label>
            <input type="text" style="color:#1EA1A1" id="price" name="price" value="800.00"> <br>
        </div>
          <div class="txtb">
