...
<html lang="en">
  <head>
   <meta charset="UTF-8">
        ...
        <title>Vamos | Studio Type 2</title>
        <script>
          function passvalues()
          {
  ...
  <table class="table">
    ...
    <tr>
      <td>
        ...
        <img src="../main/8.jpg">
        <br><br>
        <h3>A room with a studio bed with a couch which can be converted into a bed. May also have an 
additional bed. It may also have a small kitchenette with a refrigerator, a stove, and some basic 
kitchen tool.</h3>
      </div>
      </td>
      <td colspan="2">
      <form action="create_reservation.php" method = "POST" enctype="multipart/form-data" >
        <div class="txtb">
            ...
            <input type="text" style="color:#1EA1A1" id="room" name="room" value="Studio Type 2 Room"> <br>
          </div>
          <div class="txtb">
            <label><b>Price :</b></label>
            <input type="text" style="color:#1EA1A1" id="price" name="price" value="1000.00"> <br>
        </div>
          <div class="txtb">
